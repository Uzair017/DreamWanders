...
//    for international tours data fetching
$sql = "SELECT * FROM internationaltours where username ='$username'";
$result = mysqli_query($conn, $sql);
// for domestic tour data fetching
$sql2 = "SELECT * FROM domestictours where username ='$username'";
...
-->
    ...
    <h1 style="color: rgb(239, 54, 3); font-family: poppins; margin-bottom: 15px;" align="center"  >MY Packgage BOOKINGS</h1>
    <div style="padding-left: 30px; padding-right:30px;">
    <table align="center" class="table bordered-table " style="margin-bottom: 100px; margin-top: 40px;">
        <tr>
            <th colspan="4" rowspan="1" style="text-align: center; font-size:20px" >International Package Bookings</th>
        </tr>
        <tr>
            <th style=" font-size:15px">User Name</th>
            <th style=" font-size:15px">Country</th>
            <th style=" font-size:15px">No. of Days</th>
            <th style=" font-size:15px">Cost</th>
    ...
    <!-- for domestic tour bookings -->
<div style="padding-left: 30px; padding-right:30px;">
    <table align="center" class="table bordered-table " style="margin-bottom: 50px; " >
        <tr>
            <th colspan="4" rowspan="1" style="text-align: center; font-size:20px" >Domestic Package Bookings</th>
        </tr>
        <tr>
            <th style=" font-size:15px">User Name</th>
            <th style=" font-size:15px">Tourtype</th>
        ...
        <tr>
                    ...
                    <td><?php echo $arr2['tourtype']; ?></td>
                    <td><?php echo $arr2['location']; ?></td>
                    <td><?php echo $arr2['days']; ?></td>
                    <td><?php echo $arr2['cost']; ?></td>
