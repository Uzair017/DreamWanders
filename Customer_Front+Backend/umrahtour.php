    ...
    <div class="container" style=" margin-bottom: 50px;" >
        <div class="row">
            ...
            <div class="col-lg-3 col-md-12 col-12">
                <img src="images/Internationalpacks/saudia.jpeg" style="margin-top: 80px;" class="img-fluid" data-aos="zoom-in" >
            </div>
            <div class="col-lg-7 col-md-12 col-12">
                <h1 class="" data-aos="fade-up" style="color: rgb(239, 54, 3);font-family: poppins; padding-left: 70px; margin-bottom: 30px;">Umrah Package</h1>
