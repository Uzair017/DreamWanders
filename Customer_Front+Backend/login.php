...
if(isset($_POST['username'])){
    ...
    $q="select password from users where user_name='$username'";
...
<body>
    ...
    <section class="form">
        <div class="row" style="position: relative;">
            ...
            <form class="form-box" action="login.php" method="post" style="position: absolute; top: 55%; left: 50%; transform: translate(-50%, -50%); width: 500px; height: 330px; border-radius: 30px; background-color: rgb(239, 145, 3);border: 5px solid white; ">
                <h1 align="center" style=" color: white; font-family: 'Poppins', sans-serif; margin-bottom: 40px;">Login Area</h1>
                ...
                <input type="button" onclick="location.href='adminlogin.php'" value="Login as Admin" name="login" style="width: 400px; height: 35px; border: none; color: #333; font-family: 'Poppins', sans-serif; border-radius: 10px;margin-top: 10px;">
