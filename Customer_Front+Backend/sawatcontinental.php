    ...
    <div class="container" style=" margin-bottom: 50px;" >
        <div class="row">
            ...
            <div class="col-lg-3 col-md-12 col-12">
                <img src="images/hotels/hotel2.jpg" style="margin-top: 80px;" class="img-fluid" data-aos="zoom-in" >
            </div>
            <div class="col-lg-7 col-md-12 col-12">
                <h1 class="" data-aos="fade-up" style="color: rgb(239, 54, 3);font-family: poppins; padding-left: 70px; margin-bottom: 30px;">Hotel Booking</h1>
                <table border="2"  style="width: 500px; border-color: rgb(239, 54, 3); font-size: 20px;">
                    ...
                    <tr style="height: 40px;">
                        ...
                        <td >Sawat Continental Hotel</td>

                    </tr>
                    <tr style="height: 40px;">
                        <th style="padding: 10px;">Hotel Type:</th>
                        <td>Economy</td>

                    </tr>
                    <tr style="height: 40px;">
                        <th style="padding: 10px;">Hotel City:</th>
                        <td>Sawat</td>

                    </tr>
                    <tr style="height: 40px;">
                        <th style="padding: 10px;">Cost per Day:</th>
                        <td>10000 PKR</td>
                ...
                <div style="margin-top: 10px; margin-left:-60px ">
                  ...
                  Check In:    <input type="date" name="checkin"  style="width: 250px;height: 30px; border: 2px solid rgb(239, 54, 3) ;">   
                Check Out:   <input type="date" name="checkout"  style="width: 250px;height: 30px; border: 2px solid rgb(239, 54, 3) ;">   
                     <div style="margin-top: 5px;">
                     <div style=" margin-left:90px" >
                    <input type="submit" name="submit" value="Book Now" id="btn" style="border: 3px solid rgb(239, 54, 3); font-family: poppins; font-size: 17px; color: black; border-radius: 10px; padding: 5px; padding-left: 20px; padding-right: 20px; margin-left: 150px; ">
...
if(isset($_POST['checkin'])){
    ...
    $q="insert into hotelbooking(username,hname,htype,hcity,costperday,checkin,checkout) values('$username','$hname','$htype','$hcity','$costperday','$checkin','$checkout')";
