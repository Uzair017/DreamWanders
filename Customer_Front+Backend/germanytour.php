    ...
    <div class="container" style=" margin-bottom: 50px;" >
        <div class="row">
            ...
            <div class="col-lg-3 col-md-12 col-12">
                <img src="images/Internationalpacks/germany.jpeg" style="margin-top: 80px;" class="img-fluid" data-aos="zoom-in" >
            </div>
            <div class="col-lg-7 col-md-12 col-12">
                <h1 class="" data-aos="fade-up" style="color: rgb(239, 54, 3);font-family: poppins; padding-left: 70px; margin-bottom: 30px;">Germany Tour</h1>
                <table border="2"  style="width: 500px; border-color: rgb(239, 54, 3); font-size: 20px;">
                    ...
                    <tr style="height: 40px;">
                        <th style="padding: 10px;">No of Cities:</th>
                        <td>5 Cities</td>
...
if(isset($_POST['submit'])){
    ...
    $q="insert into internationaltours(username,country,days,cost) values('$username','$country','$days','$cost')";
