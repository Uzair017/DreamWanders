...
-->
        ...
        <!--nav3 ends here-->
        <!--!contact us-->
        <div class="contactus" data-aos="zoom-in" data-aos-offset="100">
        <h1 >Find Us At</h1>
        <div class="contacticons">
            <img src="images/hotels/phone.png" alt="">
            <img src="images/hotels/email.png" alt="">
            <img src="images/hotels/location.png" alt="">
        ...
        <div class="contacticondetail2">
            <a href="tel:+923456789023">+923216784222</a>
           <a href="mailto:dreamwander2@gmail.com">dreamwander@info</a>
           <a href="">Main GT Road SWL.</a>
        </div>
    </div>
        <!-- <section> -->
            <!-- <div class="row contactdiv">
               
                <div class="col-lg-4 col-md-12 col-sm-12 col-12 firsticon">
                    <a href="https://mail.google.com/mail/u/0/#inbox"><i class="fa fa-envelope"></i></a>
                </div>
                
                <div class="col-lg-4 col-md-12 col-sm-12 col-12 secondicon">

                </div>
                <div class="col-lg-4 col-md-12 col-sm-12 col-12 thirdicon"></div>
            </div> -->
            
            <!-- <div class=" contactdiv2 row">
                <div class="col-lg-4 first">1</div>
                <div class="col-lg-4 second">1</div>
                <div class="col-lg-4 third">1</div>

            </div>
        </section> -->
        <!-- <div class="row contactdiv"> -->
            <!-- <div class=" col-lg-4 col-md-12 col-sm-12 col-12 p-0 firsticon">
            <a href="https://mail.google.com/mail/u/0/#inbox"><i class="fa fa-envelope"></i></a>
            </div>
            <div class=" col-lg-4 col-md-12 col-sm-12 col-12 p-0 secondicon">
                <a href="https://mail.google.com/mail/u/0/#inbox"><i class="fa fa-envelope"></i></a></div>
                <div class=" col-lg-4 col-md-12 col-sm-12 col-12 p-0 thirdicon">
                    <a href="https://mail.google.com/mail/u/0/#inbox"><i class="fa fa-envelope"></i></a></div> -->
                    <!-- <a href="https://mail.google.com/mail/u/0/#inbox"><i class="fa fa-envelope"></i></a>
                    <a href="https://mail.google.com/mail/u/0/#inbox"><i class="fa fa-envelope"></i></a>
                    <a href="https://mail.google.com/mail/u/0/#inbox"><i class="fa fa-envelope"></i></a>
