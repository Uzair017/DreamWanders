...
if(isset($_POST['username'])){
    ...
    $q="insert into users(user_name,password,dob,gender,city) values('$username','$password','$dob','$gender','$city')";
...
<body>
    <header>
        ...
        <div class="nav01" style=" background-color: rgb(241, 144, 15);border-radius: 20px; height: 90px; display: flex; align-items: center; justify-content: center;">
            <div class="content">
    ...
    <section class="form">
        <div class="row" style="position: relative;">
            ...
            <form class="form-box" action="signup.php" method="post" style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); width: 760px; height: 450px; border-radius: 30px; background-color: rgb(239, 145, 3); border: 5px solid white;">
                <h1 align="center" style=" color: white; font-family: 'Poppins', sans-serif; margin-bottom: 40px;">Sign Up</h1>
                ...
                <div class="input-group">
                    <!-- <label for="password">Password:</label> -->
                    <input type="date" id="date"  name="date"  placeholder="Enter Date of Birth" style="width: 400px; height: 35px;border-radius: 10px;">
                    
                </div>
                <select class="form-control" id="gender" name="gender" style="width: 400px; height: 35px;border-radius: 10px;">
                    <option value="NA" selected>Select Your Gender</option>
                    <option value="Male">MALE</option>
                    <option value="Female">FEMALE</option>
                    <option value="Custom">CUSTOM</option>
                </select>
                <select class="form-control" id="city" name="city" style="width: 400px; height: 35px;border-radius: 10px; margin-top: 10px;">
                    <option value="NA" selected>Select Your City</option>
                ...
                <input type="submit" type="submit" style="width: 400px; height: 35px; border: none; color: #333; font-family: 'Poppins', sans-serif; border-radius: 10px;margin-top: 10px;">
                    <!-- <button type="submit" style="width: 400px; height: 35px; border: none; color: #333; font-family: 'Poppins', sans-serif; border-radius: 10px;margin-top: 10px;">Sign Up</button> -->
                </div>
            </form>
        </div>
    </section>
