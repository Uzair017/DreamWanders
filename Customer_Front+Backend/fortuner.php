    ...
    <div class="container" style=" margin-bottom: 50px;" >
        <div class="row">
            ...
            <div class="col-lg-3 col-md-12 col-12">
                <img src="images/cars/fortuner.jpg" style="margin-top: 80px;" class="img-fluid" data-aos="zoom-in" >
            </div>
            <div class="col-lg-7 col-md-12 col-12">
                <h1 class="" data-aos="fade-up" style="color: rgb(239, 54, 3);font-family: poppins; padding-left: 70px; margin-bottom: 30px;">Car Hire</h1>
                ...
                <div style="margin-top: 10px; margin-left: 140px;">
                    <form action="" method="POST">
                     <input type="text" name="numofdays" placeholder="Enter No of Days" style="width: 250px;height: 30px; border: 2px solid rgb(239, 54, 3) ;">   
                     <div style="margin-top: 5px;">
                    <input type="submit" name="submit" value="Book Now" id="btn" style="border: 3px solid rgb(239, 54, 3); font-family: poppins; font-size: 17px; color: black; border-radius: 10px; padding: 5px; padding-left: 20px; padding-right: 20px; margin-left: 50px; ">
...
if(isset($_POST['numofdays'])){
    ...
    $model=2020;
    $perday=16000;
    $numofdays = intval($_POST['numofdays']);
    $total = $numofdays * $perday;
    $username=$_SESSION['username'];
   
    $q="insert into carehire(username,category,carname,cmodel,costperday,numofdays,totalcost) values('$username','$category','$car','$model','$perday','$numofdays','$total')";
