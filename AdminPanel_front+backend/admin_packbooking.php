...
$sql = "SELECT * FROM internationaltours";
$result = mysqli_query($conn, $sql);
// for domestic tour data fetching
$sql2 = "SELECT * FROM domestictours";
...
<body>
    ...
    <h1 style="color: rgb(239, 54, 3); font-family: poppins; margin-bottom: 15px;" align="center"  > Packgage BOOKINGS</h1>
