...
<body>
    ...
    <h1 style="color: rgb(239, 54, 3); font-family: poppins;" align="center" >BOOKINGS</h1>
  <div class="container-fluid row" style=" margin-top: 10px; height: 200px; " >
    ...
    <div class="col-lg-2 col-sm-10 col-md-10" style="padding-top: 40px;background-color: rgb(239, 54, 3); border-radius: 30px;margin-right: 8px;">
        ...
        <button onclick="location.href='admin_packbooking.php'" style="height: 78px;width:180px; padding-left: 10px; padding-right: 10px;border: none; border-radius: 18px; font-family: poppins; font-size: 17px; font-weight: 500;">Package Bookings</button></div>
    </div>
    <div class="col-lg-2 col-sm-10 col-md-10" style="padding-top: 40px;background-color: rgb(239, 54, 3); border-radius: 30px;margin-right: 8px;">
        <div class="inner" style="height: 100px;  padding-top: 10px; ">
        <button onclick="location.href='admin_carbooking.php'" style="height: 78px; width:180px; padding-left: 10px; padding-right: 10px;border: none; border-radius: 18px; font-family: poppins; font-size: 17px; font-weight: 500;">Car Bookings</button></div>
    </div>
    
    <div class="col-lg-2 col-sm-10 col-md-10" style="padding-top: 40px;background-color: rgb(239, 54, 3); border-radius: 30px;margin-right: 8px;">
        <div class="inner" style="height: 100px;  padding-top: 10px; ">
        <button onclick="location.href='admin_hotelbooking.php'" style="height: 78px;width:180px; padding-left: 10px; padding-right: 10px;border: none; border-radius: 18px; font-family: poppins; font-size: 17px; font-weight: 500;">Hotel Bookings</button></div>
    </div>
    <div class="col-lg-3 col-sm-1 col-md-1" >
    </div>
